	...
	<div>
		<el-card class="my-info__card">
			<div slot="header">
				...
				<el-button class="header-button" type="text" @click="isRemoving = true" style="float: right;margin-left:5px;padding: 3px 0">Remove</el-button>
		...
		<el-dialog class="my-info__edit-dialog" title="Remove one teamate" :visible.sync="isRemoving" :modal-append-to-body="false">
			<el-input v-model="userid" placeholder="Please enter User ID"></el-input>
			<div slot="footer" class="dialog-footer">
				<el-button @click="isRemoving = false">Cancel</el-button>
