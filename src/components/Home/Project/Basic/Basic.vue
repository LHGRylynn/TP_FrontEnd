    ...
    mounted () {
      this.func()
		...
		methods: {
			...
			getSprintName() {
				this.axios.post('/api/sprint/getSpListByPID?ID=' + this._GLOBAL.ProjectList[this._GLOBAL.projectIndex]
						.ID)
					.then((response) => {
			...
			calculate() {
				this.axios.get("/api/task/getTaskListByPid?projectid=" + this._GLOBAL.ProjectList[this._GLOBAL
						.projectIndex].ID)
					.then((response) => {
						if (response.data.message == "成功") {
				...
				this.axios.post("/api/requirement/getReqtListByPID?ID=" + this._GLOBAL.ProjectList[this._GLOBAL
						.projectIndex].ID)
					.then((response) => {
						if (response.data.message == "成功") {
				...
				this.axios.post("/api/defect/getDefListByPID?ID=" + this._GLOBAL.ProjectList[this._GLOBAL
						.projectIndex].ID)
					.then((response) => {
						if (response.data.message == "成功") {
